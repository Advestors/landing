      ...
      <div className="container mx-auto px-6 py-20 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            {/* Badge */}
            <motion.div 
              className="inline-flex items-center gap-2 bg-gradient-to-r from-indigo-500 to-purple-600 text-white px-4 py-2 rounded-full text-sm font-semibold w-fit"
            ...
            <motion.p 
              className="text-2xl text-gray-700 leading-relaxed max-w-2xl font-medium"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              <button className="group bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white px-10 py-5 rounded-2xl font-bold text-lg flex items-center justify-center gap-3 transition-all duration-300 shadow-2xl hover:shadow-indigo-500/25 transform hover:scale-105 hover:shadow-2xl">
                Start Earning Money Now
                <ArrowRight className="w-6 h-6 group-hover:translate-x-2 transition-transform duration-300" />
              </button>
              
              <button className="group border-2 border-gray-300 hover:border-purple-400 text-gray-700 hover:text-purple-700 px-10 py-5 rounded-2xl font-bold text-lg flex items-center justify-center gap-3 transition-all duration-300 hover:shadow-xl bg-white/90 backdrop-blur-sm hover:bg-purple-50">
            ...
            >
              <p className="text-sm text-gray-500 mb-3">Trusted by industry leaders:</p>
              <div className="flex items-center gap-6 opacity-70">
                <span className="text-lg font-bold text-gray-400">Nike</span>
                <span className="text-lg font-bold text-gray-400">Coca-Cola</span>
                <span className="text-lg font-bold text-gray-400">Tesla</span>
                <span className="text-lg font-bold text-gray-400">Netflix</span>
              </div>
            </motion.div>
          </motion.div>
